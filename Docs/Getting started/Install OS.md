...
<p>We will quickly go over flashing Raspbian 64-bit, but you can choose Ubuntu or others.</p>
...
<p><span class="wysiwyg-color-green120"><strong>Note:</strong> These commands are temporary, a proper and easy way will be available soon with newer version of $tp</span>i</p>
